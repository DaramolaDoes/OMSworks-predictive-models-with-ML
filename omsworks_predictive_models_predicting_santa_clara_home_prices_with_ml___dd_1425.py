# -*- coding: utf-8 -*-
"""OMSworks predictive models: predicting Santa Clara home prices with ML | DD_1425.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1FkOLeGxW1sRx7KOKbyTNh3KTAMQoGzbU
"""

#Santa Clara, n=23; 2023-2024
...
# Santa Clara Single Family 2023-2024 Dataset
data = {
    'Date': pd.date_range(start='2023-01-01', end='2024-11-01', freq='MS'),
    'Price': [1436334, 1414322, 1389706, 1374076, 1371981, 1381096, 1401418, 1428008, 1456145, 1482824, 1505293, 1519427,
              1519348, 1511777, 1512674, 1528925, 1555676, 1580000, 1620464, 1621145, 1639337, 1657499, 1678257]
}
...
# plotting the historical 22 months (2023-2024) Santa Clara single family prices
plt.figure(figsize=(10, 6))
plt.plot(df['Date'], df['Price'], label='Historical Prices', marker='o', color='black')
plt.title('Historical Prices of Santa Clara Single Family Homes (2023-2024)')
plt.xlabel('Date')
...
#linear regression model with historical Santa Clara 2023-2024 data points
...
plt.plot(df['Date'], model.predict(X), color='purple', label="Linear Regression Line")
plt.title("Santa Clara Single Family Homes Historical 2023-2024 Prices with Linear Regression")
plt.xlabel("Date")
plt.ylabel("Price in Millions $")
...
# Santa Clara 2023-2024 single family real estate dataset
data = {
    'Date': pd.date_range(start='2023-01-01', end='2024-11-01', freq='MS'),
    'Price': [1436334, 1414322, 1389706, 1374076, 1371981, 1381096, 1401418, 1428008, 1456145, 1482824, 1505293, 1519427,
              1519348, 1511777, 1512674, 1528925, 1555676, 1580000, 1620464, 1621145, 1639337, 1657499, 1678257]
...
plt.scatter(df['Date'], df['Price'], color='black', label='Actual prices')
plt.plot(df['Date'], y_pred, color='purple', label='Linear regression line')
...
plt.text(predicted_date, predicted_price, f"${predicted_price:.2f}", fontsize=8, color='green', ha='right')
...
#ML prediction 1/1/25 - $1,679,657.10
#ML prediction 3/1/25 - $1,705,814.27
#ML prediction 6/1/25 - $1,746,601.73
...
# Inputs
purchase_price = 1503727  # Purchase price of the home
predicted_price = 1746601  # Predicted price of the home in June 2025
...
#1: 1/1/25 ML prediction being the lowest for Santa Clara single family home investors
#2: 16.15% projected percentage saved on the investment
#3: $242,874 projected dollar saved on the investment